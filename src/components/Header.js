  ...
  return (
    <Container>
      <Toolbar disableGutters sx={{ justifyContent: "start" }}>
        {" "}
        {/* disableGutters is the key to removing padding */}
        <Typography
          style={{ marginTop: "1em" }}
        ...
        {isMobile ? (
          ...
          <Box display="flex" gap={3}>
            <Button
              onClick={() => scrollTo("presentationsection")}
              smooth={true}
              color="primary"
            >
            ...
            <Button
              onClick={() => scrollTo("membershipsection")}
              color="primary"
            >
              <Typography color={"primary"} variant="h6" sx={{ flexGrow: 1 }}>
                {t("Header.becomeAMember")}{" "}
              </Typography>
            </Button>
            <Button onClick={() => scrollTo("aboutussection")} color="primary">
              <Typography color={"primary"} variant="h6" sx={{ flexGrow: 1 }}>
                {t("Header.aboutUs")}
              </Typography>
            </Button>
            <Button
              onClick={() => scrollTo("contactussection")}
              color="primary"
            >
              <Typography color={"primary"} variant="h6" sx={{ flexGrow: 1 }}>
                {" "}
